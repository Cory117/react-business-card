    ...
    return (
        <div className="info">
            ...
            <div className="btn-container">
                <a href="mailto:corydaddona1@hotmail.com" className="email-btn">
                ...
                <a href="https://www.linkedin.com/in/cory-daddona-6237a3158/" target="_blank" className="linkedin-btn">
